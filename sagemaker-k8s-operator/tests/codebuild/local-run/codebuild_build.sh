#!/bin/bash
#
# This script was downloaded from https://docs.aws.amazon.com/codebuild/latest/userguide/use-codebuild-agent.html
# DO NOT MODIFY unless you want to maintain your changes.
#
