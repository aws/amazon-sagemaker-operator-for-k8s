...
type HyperparameterTuningJobLister interface {
	...
	List(selector labels.Selector) (ret []*hyperparametertuningjob.HyperparameterTuningJob, err error)
...
// List lists all HyperparameterTuningJobs in the indexer.
func (s *hyperparameterTuningJobLister) List(selector labels.Selector) (ret []*hyperparametertuningjob.HyperparameterTuningJob, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*hyperparametertuningjob.HyperparameterTuningJob))
	})
	return ret, err
}
...
type HyperparameterTuningJobNamespaceLister interface {
	...
	Get(name string) (*hyperparametertuningjob.HyperparameterTuningJob, error)
...
// List lists all HyperparameterTuningJobs in the indexer for a given namespace.
func (s hyperparameterTuningJobNamespaceLister) List(selector labels.Selector) (ret []*hyperparametertuningjob.HyperparameterTuningJob, err error) {
...
// Get retrieves the HyperparameterTuningJob from the indexer for a given namespace and name.
func (s hyperparameterTuningJobNamespaceLister) Get(name string) (*hyperparametertuningjob.HyperparameterTuningJob, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(hyperparametertuningjob.Resource("hyperparametertuningjob"), name)
	}
	return obj.(*hyperparametertuningjob.HyperparameterTuningJob), nil
}
