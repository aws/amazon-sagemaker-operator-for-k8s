...
type HostingDeploymentLister interface {
	...
	List(selector labels.Selector) (ret []*hostingdeployment.HostingDeployment, err error)
...
// List lists all HostingDeployments in the indexer.
func (s *hostingDeploymentLister) List(selector labels.Selector) (ret []*hostingdeployment.HostingDeployment, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*hostingdeployment.HostingDeployment))
	})
	return ret, err
}
...
type HostingDeploymentNamespaceLister interface {
	...
	Get(name string) (*hostingdeployment.HostingDeployment, error)
...
// List lists all HostingDeployments in the indexer for a given namespace.
func (s hostingDeploymentNamespaceLister) List(selector labels.Selector) (ret []*hostingdeployment.HostingDeployment, err error) {
...
// Get retrieves the HostingDeployment from the indexer for a given namespace and name.
func (s hostingDeploymentNamespaceLister) Get(name string) (*hostingdeployment.HostingDeployment, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(hostingdeployment.Resource("hostingdeployment"), name)
	}
	return obj.(*hostingdeployment.HostingDeployment), nil
}
