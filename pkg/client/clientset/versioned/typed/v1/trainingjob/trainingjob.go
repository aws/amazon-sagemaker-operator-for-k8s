...
type TrainingJobInterface interface {
	Create(*trainingjob.TrainingJob) (*trainingjob.TrainingJob, error)
	Update(*trainingjob.TrainingJob) (*trainingjob.TrainingJob, error)
	UpdateStatus(*trainingjob.TrainingJob) (*trainingjob.TrainingJob, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*trainingjob.TrainingJob, error)
	List(opts v1.ListOptions) (*trainingjob.TrainingJobList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *trainingjob.TrainingJob, err error)
...
func (c *trainingJobs) Get(name string, options v1.GetOptions) (result *trainingjob.TrainingJob, err error) {
...
func (c *trainingJobs) List(opts v1.ListOptions) (result *trainingjob.TrainingJobList, err error) {
...
func (c *trainingJobs) Create(trainingJob *trainingjob.TrainingJob) (result *trainingjob.TrainingJob, err error) {
	result = &trainingjob.TrainingJob{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("trainingjobs").
...
func (c *trainingJobs) Update(trainingJob *trainingjob.TrainingJob) (result *trainingjob.TrainingJob, err error) {
	result = &trainingjob.TrainingJob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("trainingjobs").
...
func (c *trainingJobs) UpdateStatus(trainingJob *trainingjob.TrainingJob) (result *trainingjob.TrainingJob, err error) {
	result = &trainingjob.TrainingJob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("trainingjobs").
...
func (c *trainingJobs) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *trainingjob.TrainingJob, err error) {
	result = &trainingjob.TrainingJob{}
