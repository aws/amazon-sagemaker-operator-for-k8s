...
type ModelInterface interface {
	Create(ctx context.Context, model *model.Model, opts v1.CreateOptions) (*model.Model, error)
	Update(ctx context.Context, model *model.Model, opts v1.UpdateOptions) (*model.Model, error)
	UpdateStatus(ctx context.Context, model *model.Model, opts v1.UpdateOptions) (*model.Model, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*model.Model, error)
	List(ctx context.Context, opts v1.ListOptions) (*model.ModelList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *model.Model, err error)
	ModelExpansion
}
...
func (c *models) Get(ctx context.Context, name string, options v1.GetOptions) (result *model.Model, err error) {
	result = &model.Model{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("models").
...
func (c *models) List(ctx context.Context, opts v1.ListOptions) (result *model.ModelList, err error) {
...
func (c *models) Create(ctx context.Context, model *model.Model, opts v1.CreateOptions) (result *model.Model, err error) {
	result = &model.Model{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("models").
...
func (c *models) Update(ctx context.Context, model *model.Model, opts v1.UpdateOptions) (result *model.Model, err error) {
	result = &model.Model{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("models").
...
func (c *models) UpdateStatus(ctx context.Context, model *model.Model, opts v1.UpdateOptions) (result *model.Model, err error) {
	result = &model.Model{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("models").
...
func (c *models) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *model.Model, err error) {
	result = &model.Model{}
