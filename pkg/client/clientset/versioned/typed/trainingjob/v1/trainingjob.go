...
import (
	...
	v1 "github.com/aws/amazon-sagemaker-operator-for-k8s/api/trainingjob/v1"
...
type TrainingJobInterface interface {
	...
	UpdateStatus(*v1.TrainingJob) (*v1.TrainingJob, error)
	Delete(name string, options *metav1.DeleteOptions) error
	DeleteCollection(options *metav1.DeleteOptions, listOptions metav1.ListOptions) error
	Get(name string, options metav1.GetOptions) (*v1.TrainingJob, error)
	List(opts metav1.ListOptions) (*v1.TrainingJobList, error)
...
func newTrainingJobs(c *TrainingjobV1Client, namespace string) *trainingJobs {
	return &trainingJobs{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *trainingJobs) Get(name string, options metav1.GetOptions) (result *v1.TrainingJob, err error) {
...
func (c *trainingJobs) List(opts metav1.ListOptions) (result *v1.TrainingJobList, err error) {
...
func (c *trainingJobs) Watch(opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *trainingJobs) UpdateStatus(trainingJob *v1.TrainingJob) (result *v1.TrainingJob, err error) {
	result = &v1.TrainingJob{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("trainingjobs").
...
func (c *trainingJobs) Delete(name string, options *metav1.DeleteOptions) error {
...
func (c *trainingJobs) DeleteCollection(options *metav1.DeleteOptions, listOptions metav1.ListOptions) error {
	var timeout time.Duration
