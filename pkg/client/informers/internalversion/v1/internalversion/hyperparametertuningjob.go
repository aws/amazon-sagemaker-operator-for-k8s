	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.V1().HyperparameterTuningJobs(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.V1().HyperparameterTuningJobs(namespace).Watch(options)
			},
		},
		&hyperparametertuningjobv1.HyperparameterTuningJob{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *hyperparameterTuningJobInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&hyperparametertuningjobv1.HyperparameterTuningJob{}, f.defaultInformer)
}
