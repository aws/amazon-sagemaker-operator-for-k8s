...
func (in *HyperparameterTuningJobSpec) DeepCopyInto(out *HyperparameterTuningJobSpec) {
	*out = *in
	if in.HyperParameterTuningJobConfig != nil {
		...
		*out = new(commonv1.HyperParameterTuningJobConfig)
		(*in).DeepCopyInto(*out)
	}
	...
	if in.TrainingJobDefinition != nil {
		...
		*out = new(commonv1.HyperParameterTrainingJobDefinition)
		(*in).DeepCopyInto(*out)
	}
	if in.WarmStartConfig != nil {
		in, out := &in.WarmStartConfig, &out.WarmStartConfig
		*out = new(commonv1.HyperParameterTuningJobWarmStartConfig)
		(*in).DeepCopyInto(*out)
	}
	if in.Region != nil {
...
func (in *HyperparameterTuningJobStatus) DeepCopyInto(out *HyperparameterTuningJobStatus) {
	*out = *in
	if in.BestTrainingJob != nil {
		...
		*out = new(commonv1.HyperParameterTrainingJobSummary)
		(*in).DeepCopyInto(*out)
	}
	...
	if in.TrainingJobStatusCounters != nil {
		...
		*out = new(commonv1.TrainingJobStatusCounters)
		(*in).DeepCopyInto(*out)
	}
}
