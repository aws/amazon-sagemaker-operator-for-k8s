...
func (in *HostingDeploymentSpec) DeepCopyInto(out *HostingDeploymentSpec) {
	*out = *in
	...
	if in.ProductionVariants != nil {
		...
		*out = make([]commonv1.ProductionVariant, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.Models != nil {
		...
		*out = make([]commonv1.Model, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *HostingDeploymentStatus) DeepCopyInto(out *HostingDeploymentStatus) {
	*out = *in
	...
	if in.ProductionVariants != nil {
		in, out := &in.ProductionVariants, &out.ProductionVariants
		*out = make([]*commonv1.ProductionVariantSummary, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(commonv1.ProductionVariantSummary)
				(*in).DeepCopyInto(*out)
			}
		}
	}
